...
/**
 * Strings for component 'wiki', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   wiki
...
$string['cannotmanagefiles'] = 'Usted no tiene permiso para gestionar los archivos de la wiki.';
$string['cannotviewfiles'] = 'Usted no tiene permiso para ver los archivos de la wiki.';
...
$string['editfiles'] = 'Editar archivos de la wiki';
