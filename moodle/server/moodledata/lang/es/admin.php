...
/**
 * Strings for component 'admin', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   admin
...
$string['blockprotect'] = 'Proteger de eliminación';
$string['blockprotect_help'] = 'Los bloques seleccionados estarán protegido contra su eliminación de los diferentes contextos del sitio. Esta opción se utiliza principalmente para proteger los bloques de navegación y configuración cuya recuperación en caso de eliminación accidental puede ser muy compleja.';
$string['blocksettings'] = 'Gestionar bloques';
$string['blockunprotect'] = 'Desproteger';
$string['bloglevel'] = 'Visibilidad del blog';
$string['bloglevelupgrade'] = 'Actualizar visibilidad del blog';
...
<p> Los blogs serán entonces totalmente desconectados a nivel de sitio. No se eliminarán entradas de blog en el proceso. </p>
';
$string['bloglevelupgradenotice'] = 'Su sitio está utilizando un ajuste antiguo de visibilidad de blog. Se recomienda la <a href="bloglevelupgrade.php">actualización de la visibilidad del blog</a>';
...
$string['configallowthemechangeonurl'] = 'Si está activado, el tema se puede cambiar mediante la adición de theme={themename} a cualquier URL de Moodle.';
...
$string['configdebugstringids'] = 'Esta opción está diseñada para ayudar a los traductores. Muestra el archivo de idioma y la cadena de Identificación al lado de cada cadena que se emite. (Los cambios en esta configuración sólo surtirán efecto en la carga de la página siguiente).';
...
$string['configenableajax'] = 'Esta opción le permite controlar el uso de AJAX (interfaces avanzadas cliente/servidor usando Javascript-) en todo el sitio. Cuando está activada, los usuarios pueden aún elegir en su perfile si usarla o no; de otro modo, AJAX estará desactivada para todo el mundo.';
...
$string['confignavshowallcourses'] = 'Esta opción asegura que todos los cursos del sitio se muestran en la barra de navegación en todo momento.';
...
$string['configrecaptchaprivatekey'] = 'Cadena de caracteres usada para comunicarse entre su servidor Moodle y el servidor recaptcha. Obtenga una para este sitio visitando http://recaptcha';
...
$string['configrestrictmodulesfor'] = '¿Qué cursos deberían contener <b>la opción</b> de deshabilitar algunos módulos de actividad? Tenga en cuenta que este ajuste sólo se aplica a los profesores, los administradores podrán añadir cualquier actividad a un curso.';
...
$string['configsitemaxcategorydepthhelp'] = 'Esta opción especifica la profundidad máxima de las categorías-hijo mostradas';
...
$string['configuserquota'] = 'El número máximo de bytes que un usuario puede almacenar en sus carpetas de archivos privados. {$a->bytes} bytes == {$a->sisplaysize}';
...
$string['courserequestnotifyemail'] = 'El usuario {$a->user} ha solicitado un unevo curso en {$a->link}';
...
$string['deletefilterfiles'] = 'Todos los datos relacionados con el filtro \'{$a-> filter}\' han sido borrados de la base de datos. Para completar la eliminación (y para evitar que el filtro se reinstale por si mismo), debería eliminar ahora mimso este directorio del servidor: {$a->directory}';
...
$string['enablecourseajax'] = 'Habilitar edición de curso AJAX';
$string['enablecourseajax_desc'] = 'Habilitar AJAX al editar las páginas principales del curso. Note que el formato del curso y el tema deben soportar la edición AJAX y que el usuario tiene asimismo que habilitar AJAX en su perfil.';
...
$string['enablemobilewebservice'] = 'Habilitar servicio web para móviles';
...
$string['excludeoldflashclients'] = 'Se requiere la versión de reproductor Flash';
...
$string['extrauserselectorfields'] = 'Durante la selección de usuarios, buscar y mostrar en';
...
$string['invalidlangpack'] = 'para editar este paquete de idioma, necesita ponerlo en la carpeta de idioma.';
...
$string['langpackupdated'] = 'El paquete de idioma {$a} se ha actualizado con éxito';
$string['langpackupdateskipped'] = 'Se ha pasado por alto la actualización del paquete de idioma {$a}';
$string['langpackuptodate'] = 'El paqute de idioma {$a} está al día.';
...
$string['loginpageautofocus'] = 'Enfoque automático de campos en el formulario de la página de identificación de usuario';
...
$string['maturity150'] = 'Liberar candidato';
$string['maturity200'] = 'Versión estable';
$string['maturity50'] = 'Alpha';
$string['maturitycoreinfo'] = 'Su sitio está actualmente en ejecución inestable "{$a}" código de desarrollo.';
...
$string['numcoursesincombo'] = 'Máximo número de cursos en la lista combinada.';
$string['numcoursesincombo_help'] = 'La lista combinada no funciona bien con grandes cantidades de cursos. Cuando el número total de cursos sea mayor que este ajuste se mostrará un enlace a un listado de cursos dedicado, en lugar de intentar mostrar todos los cursos en la portada.';
...
$string['sessioncookiedomain'] = 'Domino de las \'cookies\'';
...
$string['soaprecommended'] = 'La instalación de la extensión SOAP es útil para los servicios web y para algunos módulos de contribución.';
...
$string['themeselect'] = 'Seleccionar tema';
...
$string['unicodeupgradenotice'] = 'En Moodle 1.6 hemos pasato todos los idiomas a Unicode. Para completar la actualización de este sitio, necesita convertir todos los datos de su base de datos a Unicode (UTF-8) utilizando nuestro script de migración. <a href="utfdbmigrate.php">¡Haga clic aquí para ejecutar ahora el script de migración</a>!';
...
$string['upgradestart'] = 'Actualizar';
