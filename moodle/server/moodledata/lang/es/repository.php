...
/**
 * Strings for component 'repository', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   repository
...
$string['confirmremove'] = '¿Está seguro de que desea eliminar este plugin de repositorio, sus opciones y <strong>todos sus ejemplos</strong> - {$a}?';
