...
/**
 * Strings for component 'auth', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   auth
...
$string['potentialidps'] = '¿Entra habitualmente en otro sitio antes de llegar aquí? <br />Elija entre las opciones de la siguiente lista para entrar en su sitio habitual:';
...
$string['stdchangepassword_expl'] = 'Si el sistema de identificación externa permite cambios de contraseña en Moodle, seleccione Sí. Este ajuste pasa por alto \'Cambiar contraseña URL\'.';
