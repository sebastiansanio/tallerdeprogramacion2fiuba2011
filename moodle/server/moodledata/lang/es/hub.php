...
/**
 * Strings for component 'hub', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   hub
...
$string['moodleorgregistrationdetail'] = 'A la Central de Cursos (hub) principal se le conoce como MOOCH, se encuentra en el sitio hub.moodle.org. Al registrar su sitio con MOOCH contribuirá con las estadísticas de la comunidad internacional de usuarios de Moodle. También puede unirse a una lista de correo de bajo volumen de envíos desde la que se le proporcionarán notificaciones relevantes y revisiones de seguridad así como información relacionada con las nuevas versiones de Moodle.';
...
$string['publishonmoodleorg'] = 'Publicar en MOOCH';
...
$string['registeron'] = 'Registre su sitio';
$string['registeronmoodleorg'] = 'Registrarse en Moodle.org (MOOCH)';
$string['registeronspecifichub'] = 'Registrar en una Central de Cursos específica';
...
$string['shareonmoodleorg'] = 'Subir este curso a MOOCH';
...
$string['specifichub'] = 'Central de Cursos específica';
