...
/**
 * Strings for component 'page', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   page
...
$string['modulename_help'] = '<b>Página</b> permite crear una página web que puede ser visualizada y editada dentro del curso.';
$string['modulenameplural'] = 'Páginas';
$string['neverseen'] = 'Nunca visto';
$string['optionsheader'] = 'Opciones';
$string['page-mod-page-x'] = 'Cualquier página del módulo de Página';
