...
/**
 * Strings for component 'qtype_calculated', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['calculated_help'] = 'Las preguntas calculadas permiten crear preguntas numéricas utilizando comodines dentro de llaves que se sustituyen por valores concretos cuando se realiza el cuestionario. Por ejemplo, la pregunta "¿Cuál es el área de un rectángulo de longitud {I} y ancho {w}?" tendría como respuesta correcta la fórmual "{l} * {w}" (donde * es el signo de multiplicación).';
$string['calculatedsummary'] = 'Las preguntas calculadas son similares a preguntas numéricas pero con números seleccionados aleatoriamente de un conjunto cuando se intenta resolver el cuestionario.';
...
$string['functiontakesonearg'] = 'La función {$a} debe tener solo un argumento';
$string['functiontakesoneortwoargs'] = 'La función {$a} debe tener uno o dos argumentos';
$string['functiontakestwoargs'] = 'La función {$a} debe tener dos argumentos';
$string['generatevalue'] = 'Generar un valor nuevo entre';
...
$string['mustenteraformulaorstar'] = 'Debe escribir una fórmula o \'*\'.';
...
$string['useadvance'] = 'Use el botón de avance para ver los errores';
