...
/**
 * Strings for component 'workshopallocation_random', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['numofrandomlyallocatedsubmissions'] = 'Asignando al azar {$a} envíos';
