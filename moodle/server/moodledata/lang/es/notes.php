...
/**
 * Strings for component 'notes', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   notes
...
$string['invalidcourseid'] = 'Id de curso {$a} no válido';
...
$string['page-notes-index'] = 'Notas de la página principal';
