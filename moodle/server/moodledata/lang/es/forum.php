...
/**
 * Strings for component 'forum', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   forum
...
$string['cannotadddiscussion'] = 'Para agregar debates a este foro hay que ser miembro de un grupo.';
