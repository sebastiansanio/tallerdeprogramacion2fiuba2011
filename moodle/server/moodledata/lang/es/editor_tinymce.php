...
/**
 * Strings for component 'editor_tinymce', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['advanced:clipboard_msg'] = 'Copiar/Cortar/Pegar no se encuentra disponible en Mozilla y Firefox.n ¿Desea obtener más información acerca de este tema?';
...
$string['advanced_dlg:code_title'] = 'Editor del código fuente HTML';
...
$string['common:browseimage'] = 'Buscar o cargar una imagen...';
$string['common:browsemedia'] = 'Buscar o cargar un audio, vídeo o applet...';
...
$string['dragmath:dragmath_desc'] = 'Inserte la ecuación';
$string['dragmath:dragmath_javaneeded'] = 'Para usar esta página necesita un navegador que admita Java. Descargue en {$a} la extensión Java más reciente.';
$string['dragmath:dragmath_title'] = 'Editor de ecuaciones DragMath';
...
$string['media_dlg:filename'] = 'Nombre de archivo';
$string['media_dlg:flash_options'] = 'Opciones Flash';
$string['media_dlg:flashvars'] = 'Flashvars';
$string['media_dlg:flv_autostart'] = 'Inicio auto.';
$string['media_dlg:flv_buffer'] = 'Buffer';
$string['media_dlg:flv_defaultvolume'] = 'Volumen predet.';
$string['media_dlg:flv_hiddengui'] = 'Ocultar GUI';
$string['media_dlg:flv_jscallback'] = 'JS Callback';
$string['media_dlg:flv_loop'] = 'Repetitivo';
$string['media_dlg:flv_options'] = 'Opciones Video Flash';
$string['media_dlg:flv_scalemode'] = 'Modo escalado';
$string['media_dlg:flv_showscalemodes'] = 'Mostrar modos escala';
$string['media_dlg:flv_smoothvideo'] = 'Video suave';
$string['media_dlg:flv_startimage'] = 'Imagen inicio';
$string['media_dlg:flv_starttime'] = 'Tiempo inicio';
...
$string['paste:plaintext_mode_sticky'] = '\'Pegar\' está ahora en modo de texto plano. Haga clic de nuevo para habilitar \'pegar\' en modo normal. Tras pegar algo, volverá al modo de pegado normal.';
...
$string['searchreplace_dlg:notfound'] = 'La búsqueda se ha completado. No se encontró el texto introducido.';
...
$string['table:desc'] = 'Inserta una nueva tabla';
...
$string['xhtmlxtras_dlg:fieldset_general_tab'] = 'Configuración general';
