...
/**
 * Strings for component 'grades', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   grades
...
$string['gradepass_help'] = 'Este parámetro determina la calificación mínima necesaria para aprobar. El valor se utiliza para la finalización de las actividades y del curso, y en el libro de calificaciones, donde las calificaciones aprobadas se destacan en verde y las no aprobadas en rojo.';
...
$string['keephigh_help'] = 'Esta opción conservará sólo las X calificaciones más altas, siendo X el valor seleccionado.';
...
$string['showuseridnumber_help'] = 'Mostrar los números de identificación del usuario en una columna adicional.';
