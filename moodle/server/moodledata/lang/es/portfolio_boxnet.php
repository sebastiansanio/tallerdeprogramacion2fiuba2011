...
/**
 * Strings for component 'portfolio_boxnet', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['err_noapikey_help'] = 'No hay ninguna clave de API configurada para este plugin. Puede obtener una en la página de desarrollo de OpenBox.';
