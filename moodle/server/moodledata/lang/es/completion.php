...
/**
 * Strings for component 'completion', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   completion
...
$string['completionnotenabled'] = 'Grado de avance no activado';
$string['completionnotenabledforcourse'] = 'El grado de avance no está activado en este curso';
$string['completionnotenabledforsite'] = 'El rado de avance no está activado en este sitio';
...
$string['nocriteriaset'] = 'No se han establecido criterios de grado de avance en este curso';
