...
/**
 * Strings for component 'message', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   message
...
$string['defaultmessageoutputs'] = 'Mensajes de salida predeterminados';
...
$string['errortranslatingdefault'] = 'Error traduciendo la configuración por defect proporcionada por la extensión (plugin); en su lugar se usará la configuración por defecto del sistema.';
...
$string['notpermitted'] = 'No permitido';
...
$string['outputdoesnotexist'] = 'El mensaje de salida no existe';
$string['outputenabled'] = 'Salida habilitada';
$string['outputnotavailable'] = 'No disponible';
$string['outputnotconfigured'] = 'No configurado';
$string['page-message-x'] = 'Caulquier página de mensajes';
...
$string['sendingviawhen'] = 'Enviando "{$a->provider}" via "{$a->processor}"';
...
$string['touserdoesntexist'] = 'No puede enviar un mensaje al usuario con id {{$a}} que no existe';
