...
/**
 * Strings for component 'folder', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   folder
...
$string['page-mod-folder-view'] = 'Página principal del módulo carpeta';
$string['page-mod-folder-x'] = 'Cualquier página del módulo Carpeta';
$string['pluginadministration'] = 'Administración de carpetas';
