...
/**
 * Strings for component 'enrol', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   enrol
...
$string['bulkuseroperation'] = 'Operación global de usuario';
...
$string['errorwithbulkoperation'] = 'Se produjo un error al procesar su cambio de matriculación global.';
...
$string['recovergrades'] = 'Recuperar calificaciones de usuario antiguas si es posible';
