...
/**
 * Strings for component 'pagetype', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   pagetype
...
$string['page-course-report-x'] = 'Cualquier informne del curso';
...
$string['page-user-profile'] = 'Solo páginas de perfil de usuario';
