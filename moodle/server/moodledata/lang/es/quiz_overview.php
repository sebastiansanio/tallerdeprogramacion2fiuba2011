...
/**
 * Strings for component 'quiz_overview', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['optonlygradedattempts'] = 'sólo el intento que es calificado para cada usuario ({$a})';
