<?php $this->cache['es_ar']['core_install'] = array (
...
Así se corregirán los enlaces admin en Moodle.</p>',
  ...
  'configfilenotwritten' => '<p>El script de instalación no ha podido crear automáticamente un archivo config.php con las especificaciones elegidas. Por favor, copie el siguiente código en un archivo llamado config.php y coloque ese archivo en el directorio raíz de Moodle.</p>',
...
La base de datos puede ser creada si el usuario de la base de datos tiene los permisos necesarios, el nombre de usuario y contraseña ya deben existir. El prefijo de la tabla es opcional.',
  ...
  'nativemssqlhelp' => 'Ahora tiene que configurar la base de datos donde se almacenarán la mayoría de los datos de Moodle. Esta base de datos ya ha debido ser creada al igual que un nombre de usuario y su contraseña para poder acceder a ella. El prefijo de la tabla es obligatorio.',
  'nativeoci' => 'Oracle (native/oci)',
  'nativeocihelp' => 'Ahora tiene que configurar la base de datos donde se almacenarán la mayoría de los datos de Moodle. Esta base de datos ya ha debido ser creada al igual que un nombre de usuario y su contraseña para poder acceder a ella. El prefijo de la tabla es obligatorio.',
...
panel de control o algo similar. Lamentablemente, esto entra en conflicto con la ubicación estándar para las páginas de administración de Moodle. Usted puede solucionar este problema, renombrando el directorio admin en su instalación Moodle, poniendo un nuevo nombre aquí. Por ejemplo: <em> moodleadmin </em>. Esto solucionará los enlaces de administración en instalación Moodle.',
  ...
  'pathssubdirroot' => 'Ruta completa del directorio de instalación de Moodle.',
  ...
  'phpversionhelp' => '<p>Moodle requiere al menos una versión de PHP 4.3.0 o 5.1.0 ((5.0.x tiene una serie de problemas conocidos).</p>
...
<p>Las sesiones deben estar activadas en el archhivo php.ini para el parámetro session.auto_start.</p>',
  ...
  'nativesqlsrvhelp' => 'Ahora tiene que configurar la base de datos donde se almacenarán la mayoría de los datos de Moodle. Esta base de datos ya ha debido ser creada al igual que un nombre de usuario y su contraseña para poder acceder a ella. El prefijo de la tabla es obligatorio.',
