<?php $this->cache['es_ar']['theme_brick'] = array (
  'pluginname' => 'Brick',
  'region-side-post' => 'Derecha',
  'region-side-pre' => 'Izquierda',
  'choosereadme' => '<div class="clearfix">
...
<div class="theme_description">
  ...
  'configtitle' => 'Brick settings',
  'logo' => 'logotipo',
  'logodesc' => 'Change the logo of this theme by entering the URL to a new one (i.e., http://www.somesite/animage.png). As a reference, the default logo is 265px wide by 60px high. A transparent PNG will work best.',
  'linkcolor' => 'enlace',
  'linkcolordesc' => 'Establece el color de los enlaces en el tema, utilice el código HTML hexadecimal.',
  'linkhover' => 'linkhover',
  ...
  'maincolorlinkdesc' => 'Link color for menu bar and block titles.',
