...
/**
 * Strings for component 'install', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   install
...
$string['databasesettingssub_mssql'] = '<b>Tipo:</b> SQL*Server (no UTF-8) <b><strong class="errormsg">¡Experimental! (no usar en modo de producción)</strong></b><br /> 
...
$string['nativemssqlhelp'] = 'Ahora tiene que configurar la base de datos donde se almacenarán la mayoría de los datos de Moodle. Esta base de datos ya ha debido ser creada al igual que un nombre de usuario y su contraseña para poder acceder a ella. El prefijo de la tabla es obligatorio.';
...
$string['nativeocihelp'] = 'Ahora tiene que configurar la base de datos donde se almacenarán la mayoría de los datos de Moodle. Esta base de datos ya ha debido ser creada al igual que un nombre de usuario y su contraseña para poder acceder a ella. El prefijo de la tabla es obligatorio.';
...
$string['nativesqlsrvhelp'] = 'Ahora tiene que configurar la base de datos donde se almacenarán la mayoría de los datos de Moodle. Esta base de datos ya ha debido ser creada al igual que un nombre de usuario y su contraseña para poder acceder a ella. El prefijo de la tabla es obligatorio.';
