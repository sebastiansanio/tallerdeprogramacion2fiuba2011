...
/**
 * Strings for component 'auth_ldap', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   auth_ldap
...
$string['didntgetusersfromldap'] = 'No se han conseguido usuarios de  LDAP -- error? -- saliendo';
...
$string['rootdseerror'] = 'Error al consultar rootDSE para el Directorio Activo';
