...
/**
 * Strings for component 'moodle', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   moodle
...
$string['adminhelphealthcenter'] = 'Detección automática de problemas del sitio';
...
$string['backuplogshelp'] = 'Si se activa, los registros de actividad del curso serán incluidos en las copias de seguridad';
...
$string['coursereasonforrejecting'] = 'Rasones para rechazar esta solicitud';
...
{$a->extendurl}';
$string['expirynotify_help'] = '<p>Notificación de la fecha en la que finaliza el plazo de matriculación</p>';
...
$string['flashlinkmessage'] = 'Por favor, actualice ahora Flash.';
$string['flashupgrademessage'] = 'Se necesita el plugin Flash para ver este contenido, pero su versión es demasiado antigua.
...
$string['frontpagedescriptionhelp'] = 'Esta descripción del sitio aparecerá en la página principal';
...
/o modificarlo bajo los términos de la GNU (General Public License) publicada por la Fundación para el Software Libre, ya sea la versión 3 de dicha Licencia, o (a su elección) cualquiera posterior.
...
Vera la página de información de Licencia de Moodle para más detalles: http://docs.moodle.org/en/License';
...
$string['groupmodeforce_help'] = '<P>Si el modo grupo está "forzado" a nivel de curso,
   este modo se aplicará a cada actividad dentro del
   mismo. Las configuraciones individuales de los grupos
   para las actividades del curso no serán tenidas en cuenta.</p>

<p>Esto es útil cuando, por ejemplo, alguien quiere
   desarrollar un curso para una cantidad grupos diferentes.</p>';
...
$string['local'] = 'Local';
$string['localplugindeleteconfirm'] = 'Está a punto de eliminar competamente el plugin local \'{$a}\'. Esta acción eliminará toda la información en la base de datos asociada con dicho plugin. ¿Está SEGURO de que desea continuar?';
$string['localplugins'] = 'Plugins locales';
$string['localpluginsmanage'] = 'Gestionar plugins locales';
...
$string['maxnumcoursesincombo'] = 'Hojear <a href="{$a->link}">{$a->numberofcourses} cursos</a>.';
...
$string['messageprovider:notices_help'] = 'Éstas son noticias que un administrador podría estar interesado en ver.';
...
$string['missingcountry'] = 'Escribir: país';
...
$string['moduledeleteconfirm'] = 'Está a punto de borrar completamente el módulo \'{$a}\'. Esto borrará de la base de datos todo lo asociado con este módulo. ¿Está SEGURO de que desea continuar?';
...
$string['pictureofuser'] = 'Usar magen';
...
$string['restoretositeadding'] = 'Atención: Está a punto de restaurar la portada del sitio añadiéndole datos.';
$string['restoretositedeleting'] = 'Atención: Está a punto de restaurar la página principal del sitio eliminando la información anterior.';
...
$string['rsserrorguest'] = 'Esta fuente utiliza el acceso de invitados para acceder a los datos, pero el invitado no tiene permiso para leer los datos. Visite la ubicación original de la que esta fuente proviene (URL) como un usuario válido y obtenga de allí un nuevo enlace RSSí.';
...
$string['screenreaderuse_help'] = 'Si se ajusta a SÍ, se proporcionará una interfaz más accesible en distintos lugares (e.g., chat).';
...
$string['separatedandconnectedinfo'] = 'Cada mensaje puede calificarse usando una escala basada en la teoría del <strong>conocimiento individualista y relacionado</strong>.
...
$string['uploadextension'] = 'Subida del archivo detenida por extensión';
