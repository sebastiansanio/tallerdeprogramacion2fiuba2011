...
/**
 * Strings for component 'workshop', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   workshop
...
$string['strategy_help'] = '<p>La estrategia de clasificación determina la forma de evaluación utilizados y el método de califiación de lños envíos. Hay 4 opciones:</p>
...
$string['subplugintype_workshopallocation_plural'] = 'Presentación de los métodos de asiganción';
