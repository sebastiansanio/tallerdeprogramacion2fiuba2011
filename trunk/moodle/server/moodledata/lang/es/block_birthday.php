...
$string['dateformateures'] = 'Formato EUR_ES: \'%d/%m/%Y\'';
$string['dateformat_info'] = 'Escoje el formato (ISO, USA, EUR, EUR_ES) de la fecha que utilice (por defecto es ISO).';
...
$string['strftimedate'] = '	
%B %d';
$string['user_info_field_days'] = 'Número de días para visualizar los cumpleaños (por defecto es 0 que muestra sólo los cumpleaños del día)';
