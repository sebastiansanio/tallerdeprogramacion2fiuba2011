...
/**
 * Strings for component 'question', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   question
...
$string['cannotdeletemissingbehaviour'] = 'No se puede desinstalar \'Sin comportamiento\'. Se requiere por el sistema.';
...
$string['marks'] = 'Puntos';
$string['matcherror'] = 'Las calificaciones no corresponden con las opciones de calificación - salando pregunta';
...
$string['questionbehavioursdisabled'] = 'Comportamientos de pregunta a desactivar';
$string['questionbehavioursorder'] = 'Orden de comportamientos de pregunta';
...
$string['showquestiontext'] = 'Mostrar el texto d ela pregunta en la lista de preguntas';
...
$string['yougotnright'] = 'Ha selecciona correctamente {$a}';
