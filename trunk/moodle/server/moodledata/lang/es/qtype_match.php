...
/**
 * Strings for component 'qtype_match', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   qtype_match
...
$string['editingmatch'] = 'Editando una pregunta de emparejamiento';
...
$string['match_help'] = 'Las preguntas de emparejamiento requieren para su resolución que se establezcan de forma correcta las relaciones entre una lista de nombres o enunciados (preguntas) y otra lista de nombres o enunciados (respuestas).';
$string['matchsummary'] = 'La respuesta a cada una de las sub-preguntas debe seleccionarse a partir de una lista de posibilidades.';
