...
/**
 * Strings for component 'block_selfcompletion', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['alreadyselfcompleted'] = 'Usted ya se ha marcado como completo en este curso';
$string['completecourse'] = 'Completar curso';
$string['pluginname'] = 'Autocompletar';
$string['selfcompletion'] = 'Autocompletar';
