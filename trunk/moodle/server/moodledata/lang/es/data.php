...
/**
 * Strings for component 'data', language 'es', branch 'MOODLE_21_STABLE'
 *
 * @package   data
...
$string['addtemplate'] = 'Plantilla Agregar';
...
$string['commentsoff'] = 'No está activada la posibilidad de hacer comentarios';
...
$string['entrieslefttoadd'] = 'Debe agregar {$a->entriesleft} entrada(s) más para completar esta actividad.';
...
$string['subplugintype_datapreset'] = 'Preestablecido';
