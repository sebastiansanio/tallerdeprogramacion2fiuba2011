...
/**
 * Strings for component 'qtype_multichoice', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['multichoice_help'] = 'En respuesta a una pregunta (puede incluir una imagen) el alumno escoje la respuesta entre varias respuestas posibles. 
