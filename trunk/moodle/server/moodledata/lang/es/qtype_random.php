...
/**
 * Strings for component 'qtype_random', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['editingrandom'] = 'Editando una pregunta aleatoria';
$string['includingsubcategories'] = 'Incluyendo subcategorías';
$string['random'] = 'Aleatoria';
$string['random_help'] = 'Una pregunta aleatoria no es un tipo de pregunta sino una manera de insertar en un cuestionario una pregunta escogida al azar entre las de una categoría determinada.';
