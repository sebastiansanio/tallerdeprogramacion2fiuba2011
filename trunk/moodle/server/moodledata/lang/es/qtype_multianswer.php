...
/**
 * Strings for component 'qtype_multianswer', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['addingmultianswer'] = 'Agregando una pregunta con respuestas anidadas (Cloze)';
...
$string['editingmultianswer'] = 'Editando una pregunta con respuestas anidadas (Cloze)';
...
$string['multianswer_help'] = 'Respuestas incrustadas (Cloze) consisten en  un  texto con preguntas tipo respuestas de opción múltiple o respuesta corta incrustadas en su interior.';
...
$string['questionnadded'] = '"Pregunta agregada"';
