...
/**
 * Strings for component 'report_customlang', language 'es', branch 'MOODLE_21_STABLE'
 *
...
$string['modifiednum'] = 'Hay {$a} cadenas modificadas. Debe introducirlas en el disco para almacenarlas de forma permanebte.';
